...
function selectMirror(){
  ...
  MirrorBackup=(["debian0"]="" ["debian1"]="http://deb.debian.org/debian" ["debian2"]="http://archive.debian.org/debian" ["ubuntu0"]="" ["ubuntu1"]="http://archive.ubuntu.com/ubuntu" ["ubuntu2"]="http://ports.ubuntu.com" ["centos0"]="http://mirrors.tuna.tsinghua.edu.cn/centos-vault" ["centos1"]="http://mirrors.tuna.tsinghua.edu.cn/centos-vault" ["centos2"]="http://vault.centos.org")
